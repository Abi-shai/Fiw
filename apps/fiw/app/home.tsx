...
const styles = StyleSheet.create({
  ...
  logoText: { color: Colors.surface, fontWeight: '800', fontSize: 16, letterSpacing: -0.5 },
  profileBtn: {
    width: 40, height: 40,
  ...
  question: { fontSize: 22, fontWeight: '700', color: Colors.textPrimary, marginBottom: 16 },
  searchBar: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  serviceLabel: { fontSize: 11, fontWeight: '600', color: Colors.textPrimary },
});
